...
if (isset($_POST['editar'])) {
    ...
    $actualizarConsulta = "UPDATE ingresos SET nombre = '$nuevoNombre', valor = '$nuevoValor' WHERE id = $id";
    $resultadoActualizar = mysqli_query($conexion, $actualizarConsulta);

    if ($resultadoActualizar) {
        header('Location: ingresos.php'); // Redirigir después de la edición
    } else {
...
<body>
    <h1 style="text-align: center; color: #007bff; font-weight: bold;">Editar Ingreso</h1>
    ...
    <br>
    <a href="ingresos.php" style="margin-top: 30px; text-align: center; background-color: blue; padding: 20px; color: white; font-weight: bold;">Volver</a>
