...
if (isset($_POST['editar'])) {
    ...
    $actualizarConsulta = "UPDATE metas SET nombre = '$nuevoNombre', valor = '$nuevoValor' WHERE id = $id";
    $resultadoActualizar = mysqli_query($conexion, $actualizarConsulta);

    if ($resultadoActualizar) {
        header('Location: metas.php'); // Redirigir después de la edición
    } else {
...
<body>
    <h1 style="text-align: center; color: #007bff; font-weight: bold;">Editar Meta</h1>
    ...
    <br>
    <a href="metas.php" style="margin-top: 30px; text-align: center; background-color: blue; padding: 20px; color: white; font-weight: bold;">Volver</a>
