...
<head>
    ...
    <title>Registrar y Mostrar Metas</title>
...
<body>
<form action="insertar-meta.php" method="post">
        <div style="display: flex; justify-content: center; align-items: center; min-height: 100vh;">
            <div style="background-color: rgba(255, 255, 255, 0.9); padding: 10px; border-radius: 5px;">
                <h1 style="text-align: center; color: #007bff; font-weight: bold;">Datos de registro de meta</h1>
                <table class="table caption-top">
                    <thead>
                        <tr>
                            <th scope="col">NOMBRE</th>
                            <th scope="col">VALOR</th>
                            <th scope="col">ABONO INICIAL</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-2"><input type="text" name="abono_inicial" class="form-control" placeholder="Abono inicial"></td>
                        </tr>
                    </tbody>
                </table>
                <br>
