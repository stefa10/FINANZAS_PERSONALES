...
<head>
    ...
    <title>Registrar y Mostrar Ingresos</title>
...
<body>
<form action="insertar-ingresos.php" method="post">
        <div style="display: flex; justify-content: center; align-items: center; min-height: 100vh;">
            <div style="background-color: rgba(255, 255, 255, 0.9); padding: 20px; border-radius: 5px;">
                <h1 style="text-align: center; color: #007bff; font-weight: bold;">Datos de registro de ingresos</h1>
